      ...
      <div className="relative z-10 w-full max-w-md animate-slideIn">
        ...
        <div className="flex items-center gap-3 justify-center mb-8">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <p className="text-sm text-slate-200">Create Account</p>
            </div>
          </Link>
        </div>
        ...
        <div className="glass-card p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-400">Start hosting quizzes in seconds</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="submit" 
              className="btn btn-primary w-full text-base py-4 flex items-center justify-center gap-2 mt-6"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
